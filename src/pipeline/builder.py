...
from pipeline.branch import L2GBranch, G2LBranch
...
def build_branches(config_path: str) -> Dict:
    ...
    branches = {
        'L2GBranch': L2GBranch(units=_create_l2g_units(config['L2GBranch'], components)),
        'G2LBranch': G2LBranch(units=_create_g2l_units(config['G2LBranch'], components)),
    }
